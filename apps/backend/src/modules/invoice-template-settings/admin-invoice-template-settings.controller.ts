...
export class AdminInvoiceTemplateSettingsController {
  ...
  @Get()
  // Same reasoning as admin-invoice-settings.controller.ts: every invoice print
  // (retail and wholesale) reads this, so any signed-in admin may; writing
  // stays restricted below.
  async get() {
