...
const SECTIONS: { base: string; label: string }[] = [
  ...
  { base: "/promo-videos", label: "Promo Videos" },
  { base: "/newsletter-campaigns", label: "Newsletter Campaigns" },
  { base: "/newsletter-templates", label: "Newsletter Templates" },
  { base: "/newsletter-segments", label: "Newsletter Segments" },
