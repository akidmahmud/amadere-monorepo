...
// reason as the blocker/media import routes: the catch-all reads the body
// via `req.text()`, which corrupts a multipart CSV upload.
...
export async function POST(req: NextRequest) {
  ...
  async function call(token: string | undefined) {
    return fetch(`${BACKEND_URL}/api/v1/admin/net-profit/recovery/import`, {
      method: "POST",
