...
export function BackToTopButton() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-[18px] right-[14px] z-[120] grid h-[42px] w-[42px] place-items-center rounded-full border-[1.5px] border-header-green bg-white text-header-green shadow-[0_6px_18px_rgba(30,43,34,.18)] transition-[opacity,visibility,background-color,color] duration-200 hover:bg-header-green hover:text-white md:bottom-[26px] md:right-[22px] md:h-[46px] md:w-[46px] ${
