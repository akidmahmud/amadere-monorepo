...
export function buildPackSizeOptions(product: PublicProductDetailDto): PackSizeOptionData[] {
...
export function defaultVariantId(product: PublicProductDetailDto): string | undefined {
