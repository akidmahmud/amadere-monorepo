...
/** Wide cards for non-product pages. Product shares use their own 1080px square. */
export const OG_IMAGE = { width: 1200, height: 630 } as const;

/**
 * Preserve the complete source on an NxN square for product share images.
 * Square uploads fill it exactly; non-square artwork is contained on white.
 * JPEG keeps the upstream image compatible with social image rendering.
 */
